	...
	while(*str)
	{
		...
		if(symbol >= 0x2E && symbol <= 0x3B)
		{
			for(uint8_t width = 0; width < calibri_20ptDescriptorsBlock0[symbol - DESCRIPTORSBLOCK0_OFFSET][0]; width++)
			{
				...
				{
					if(calibri_20ptBitmapsBlock0[calibri_20ptDescriptorsBlock0[symbol - DESCRIPTORSBLOCK0_OFFSET][1] + width] & (1 << height))
						LCD_drawPixel(x, (y + 24 - height), fontColor);  //black
				}
				for(uint8_t height = 0; height < 8; height++)
				{
					if(calibri_20ptBitmapsBlock0[calibri_20ptDescriptorsBlock0[symbol - DESCRIPTORSBLOCK0_OFFSET][1]
																	+	width + calibri_20ptDescriptorsBlock0[symbol - DESCRIPTORSBLOCK0_OFFSET][0]]
							&(1 << height))
						LCD_drawPixel(x, (y + 16 - height), fontColor);  //black
				}
				for(uint8_t height = 0; height < 8; height++)
				{
					if(calibri_20ptBitmapsBlock0[calibri_20ptDescriptorsBlock0[symbol - DESCRIPTORSBLOCK0_OFFSET][1]
																	+ width + 2*calibri_20ptDescriptorsBlock0[symbol - DESCRIPTORSBLOCK0_OFFSET][0]]
							&(1 << height))
						LCD_drawPixel(x, (y + 8 - height), fontColor);  //black
				}
				x++;
			}
		}
		...
		if(symbol >= 0xC0)
		{
			for(uint8_t width = 0; width < calibri_20ptDescriptorsBlock1[symbol - DESCRIPTORSBLOCK1_OFFSET][0]; width++)
			{
				for(uint8_t height = 0; height < 8; height++)
				{
					if(calibri_20ptBitmapsBlock1[calibri_20ptDescriptorsBlock1[symbol - DESCRIPTORSBLOCK1_OFFSET][1] + width] & (1 << height))
						LCD_drawPixel(x, (y + 24 - height), fontColor);  //black
				}
				for(uint8_t height = 0; height < 8; height++)
				{
					if(calibri_20ptBitmapsBlock1[calibri_20ptDescriptorsBlock1[symbol - DESCRIPTORSBLOCK1_OFFSET][1]
																	+	width + calibri_20ptDescriptorsBlock1[symbol - DESCRIPTORSBLOCK1_OFFSET][0]]
							&(1 << height))
						LCD_drawPixel(x, (y + 16 - height), fontColor);  //black
				}
				for(uint8_t height = 0; height < 8; height++)
				{
					if(calibri_20ptBitmapsBlock1[calibri_20ptDescriptorsBlock1[symbol - DESCRIPTORSBLOCK1_OFFSET][1]
																	+ width + 2*calibri_20ptDescriptorsBlock1[symbol - DESCRIPTORSBLOCK1_OFFSET][0]]
							&(1 << height))
						LCD_drawPixel(x, (y + 8 - height), fontColor);  //black
				}
				x++;
